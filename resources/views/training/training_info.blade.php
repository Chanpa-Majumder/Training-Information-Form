	   ...
	   <div class="row">
	    <div class="col-md-12">
	       <div class="col-md-2"></div>
	        ...
	        <div class="col-md-8">
				<h2 align="center">Training Information Form</h2>
				  ...
				  <div class="form-group">
                    ...
                    <div class="row">					
						<div class="col-md-12">
							...
							<div class="col-md-10">
								<div class="well">
									  <label>Name</label><input type="text" class="form-control" id="name" placeholder="Name" name="name"><br>
									  <label>Testimonial</label><textarea class="form-control" id="content" placeholder="Testimonial" rows="5" name="testimonial"></textarea>
								</div>	
							</div>
                        </div>							
					</div>	
